...
- `LIGHTSPEED_STACK_NO_OKP_CONFIG`: Host path to the no-OKP Lightspeed stack YAML used by `compose.okp-disabled.override.example.yaml` (default: `configs/extra-files/lightspeed-stack-no-okp.yaml`)
