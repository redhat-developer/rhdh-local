...
Or, for builds from a given `release-1.y` branch (for example, 1.9), set the variable as follows.

```sh
RHDH_IMAGE=quay.io/rhdh-community/rhdh:next-1.9
```
...
```sh
RHDH_IMAGE=registry.redhat.io/rhdh/rhdh-hub-rhel9:1.9.1
```
