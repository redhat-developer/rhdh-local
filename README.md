...
If you're using an Apple Silicon (M1/M2) Mac, the images from `quay.io/rhdh/rhdh-hub-rhel9` cannot be used, as they are not compatible with the ARM64 architecture.
