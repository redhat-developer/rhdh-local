...
5. [Plugin division mode: schema](docs/rhdh-local-guide/plugin-division-mode-schema.md) - single PostgreSQL database with one schema per plugin (no `CREATEDB`)
6. [Orchestrator Workflow Guide](./orchestrator/README.md) - using Orchestrator with RHDH to develop workflows.
7. [Developer Lightspeed Guide](./developer-lightspeed/README.md) - using Developer Lightspeed in RHDH Local.
